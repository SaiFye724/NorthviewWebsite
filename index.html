...
<head>
    ...
    <title>Home | Northview High</title>
...
$(document).ready(function(){
	...
	form2.on('submit', function(e) {
...
</script>                <div class="nav nav-container">
                <div class="nav-top">
                    <div id="mission-nav">
        ...
        <div class="home-body">
            <div id="home-alert">
                <h4><b>Goodbye Seniors! <3</b></h4><i id="close-homealert" class="fa fa-close"></i>
            </div>
            <div class="Wallop">
                                <div class="Wallop-list">
                    <button class="Wallop-buttonPrevious"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>
                    <button class="Wallop-buttonNext"><i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                    <div class='Wallop-item Wallop-item--current'><img src='img/hero/SummerHours.png'/></div><div  class='Wallop-item'><img src='img/hero/northviewpic.png'/></div>                </div>
            <div id="home-mid-body">
                <div class="ilinks-container">
                ...
                <div class="events events-container">
                    <h3>Upcoming Events</h3>
                    <hr>
                    <div class='event-block event-02'><div class='event-date-block'><h4>Aug</h4><h5>03</h5></div><div class='event-information-block'><h4>Freshmen Orientation 6-7:30pm</h4><h5>Aug 03</h5></div></div><div class='event-block event-02'><div class='event-date-block'><h4>Aug</h4><h5>04</h5></div><div class='event-information-block'><h4>Senior (9 am) and Junior (10 am) Info Day</h4><h5>Aug 04</h5></div></div><div class='event-block event-02'><div class='event-date-block'><h4>Aug</h4><h5>04</h5></div><div class='event-information-block'><h4>Sophomore Info Day 11:00 am</h4><h5>Aug 04</h5></div></div><div class='event-block event-02'><div class='event-date-block'><h4>Aug</h4><h5>07</h5></div><div class='event-information-block'><h4>First Day of School</h4><h5>Aug 07 @ Northview High School, 8:20-3:30 AM</h5></div></div>                    <a href="calendar.php">
                        <div class="btn see-more-eventsbtn">SEE ALL EVENTS</div>
                    </a>
                </div>
                <div class="wpoll-container">
                    <form id="form"></form>
                </div>
                <div id="hidden-ilinks" class="ilinks-container hidden">
                    <h3>Important Links</h3>
                    <hr>
                    <div id="ilUL">
                        <ul>
        ...
        <script>
         // Set the date we're counting down to
            var countDownDate = new Date("May 25, 2017 19:30:00").getTime();
            ...
            var x = setInterval(function() {
              ...
              document.getElementById("counter-to-grad").innerHTML = days + "d " + hours + "h "
              + minutes + "m " + seconds + "s ";

              // If the count down is finished, write some text 
              if (distance < 0) {
                clearInterval(x);
                document.getElementById("counter-to-grad").innerHTML = "EXPIRED";
              }
            }, 1000);
        </script>
                    <footer>
