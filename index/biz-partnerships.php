...
<html lang="en">
    <head>
        ...
        <title>Business Partnerships | Northview High</title>
    ...
    <div id="important-links">
        <h4>IMPORTANT LINKS</h4>
            ...
            <a href="../yearbook.php" target="_blank" style="color: black;"><li>Senior Ad Info</li></a><a href="../linked_files/about/FreshmanCampFlyer.pdf" target="_blank" style="color: black;"><li>Freshman Camp Flyer</li></a><a href="../linked_files/ParkingApp1718.doc" target="_blank" style="color: black;"><li>Parking Application 2017-18</li></a><a href="https://www.northviewcounseling.com/summer-assignments-2017" target="_blank" style="color: black;"><li>Summer Assignments 2017</li></a><a href="https://www.northviewcounseling.com/" target="_blank" style="color: black;"><li>Northview Counseling</li></a><a href="https://www.northviewcounseling.com/transcript-requests-" target="_blank" style="color: black;"><li>Request A Transcript</li></a><a href="https://www.peachjar.com/index.php?a=28&b=138&region=68281" target="_blank" style="color: black;"><li>Northview Peachjar</li></a><a href="http://session.cadystudios.com/" target="_blank" style="color: black;"><li>Cady Studios</li></a><a href="https://www3.fultonschools.org/hb91/home/index2" target="_blank" style="color: black;"><li>FCS HB91 Petition Form</li></a><a href="https://www.commonsense.org/education/digital-citizenship" target="_blank" style="color: black;"><li>Digital Citizenship Application</li></a><a href="https://www.youtube.com/watch?v=44znsLcLROw" target="_blank" style="color: black;"><li>NHS Morning Show (May 11)</li></a>        </ul>
                ...
                <div id="page-content">
                    <h3>PARTNERS IN EDUCATION</h3>
                    <hr>
                    <h4><b>2015-2016</b></h4>
                    <h4><b>WE ARE PROUD TO HAVE YOU AS OUR BUSINESS PARTNER!</b></h4>
                    <p><i>Northview High School would like to express its gratitude to all our business partners. Generous contributions from our partners have helped Northview achieve our success. The following business are vital links to helping our school and students move upward and onward!</i></p>
                    <b>If you are interested in becoming a business partner for the 2015-16 school year click on this link:</b><br>
                    <a href="linked_files/biz-partnerships/Business&#32;Partner&#32;Perks&#32;2015-16.pdf" target="_blank"><div class="btn biz-perks-btn"><i class="fa fa-download" aria-hidden="true"></i>  DOWNLOAD PERKS</div></a>
                    <a href="linked_files/biz-partnerships/2015-2016&#32;Business&#32;Partnership&#32;Agreement.pdf" target="_blank"><div class="btn biz-agreement-btn"><i class="fa fa-download" aria-hidden="true"></i>  DOWNLOAD AGREEMENT</div></a>
                    <p style="display: inline-block;"><i>Northview High School is proud to have the following business partners for the 2015-16 year.</i></p>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/c2_logo.jpg" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <a href="https://www.c2educate.com/locations/johns-creek-sat-tutoring/"><h4>C2 Educational Center</h4></a>
                            <p>C2 Education Center, Johns Creek<br>
                            3630 Peachtree Parkway #504<br>
                            Suwanee, GA 30024<br>
                            <b>Tel:</b> (770) 495-7756<br>
                            <b>Fax:</b> (770) 495-7758</p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/chikfila_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <h4>Chick-Fil-A at John's Creek</h4>
                            <p>Chick-Fil-A at John's Creek<br>
                            3643 Peachtree Parkway<br>
                            Suwanee, GA 30024<br>
                            <b>Contact: </b> Steve Troutman<br>
                            <b>Tel:</b> (770) 813-1594</p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/drivesmartga_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <h4>Johns Creek Driving School</h4>
                            <p>Johns Creek Driving School<br>
                            6000 Medlock Bridge Pkwy Ste E100<br>
                            Johns Creek, GA 30022<br>
                            Driving School, Drivers Ed, Driving Lessons, Road Test<br>
                            Services, Defensive Driving Courses</p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/twistedtaco1516_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <a href="http://northviewhigh.com/index/twistedtaco.com"><h4>Twisted Taco</h4></a>
                            <p>Twisted Taco<br>
                            9700 Medlock Bridge Rd. #110<br>
                            Johns Creek, GA 30097<br>
                            <b>Tel:</b> (678) 822-5900<br>
                            <a href="http://northviewhigh.com/index/twistedtaco.com">twistedtaco.com</a></p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/promised_logo.jpg" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <a href="http://northviewhigh.com/index/www.PromiseLearningATL.com"><h4>Promise Learning Incorporated</h4></a>
                            <p>Promise Learning Incorporated<br>
                            PO Box 501873<br>
                            Atlanta, GA 31150<br>
                            <b>Tel: </b> (678) 559-5512<br>
                            <a href="http://northviewhigh.com/index/www.PromiseLearningATL.com">www.PromiseLearningATL.com</a></p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/F2O1516_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <h4>Fresh to Order</h4>
                            <p>Fresh to Order<br>
                            10900 Medlock Bridge Rd<br>
                            Johns Creek, GA 30097<br>
                            <b>Tel:</b> (678) 720-9444<br>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/FocusedDirection_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <a href="http://northviewhigh.com/index/focuseddirection.com"><h4>Focused Direction</h4></a>
                            <p>Focused Direction<br>
                            11820 Devon Downs Trail<br>
                            Johns Creek, GA 30005<br>
                            <a href="mailto:mcleary@focuseddirection.com">mcleary@focuseddirection.com</a><br>
                            <a href="http://northviewhigh.com/index/focuseddirection.com">focuseddirection.com</a></p>
                        </div>
                    </div>
                    <div class="biz-partner">
                        <div class="biz-partner-image">
                            <img src="img/biz-partnerships/RicciOrthodontics1516_logo.png" width="100%">
                        </div>
                        <div class="biz-partner-bio">
                            <a href="http://northviewhigh.com/index/ricciortho.com"><h4>Ricci Orthodontics</h4></a>
                            <p>Ricci Orthodontics<br>
                            10475 Medlock Bridge Rd<br>
                            Johns Creek, GA 30097<br>
                            <b>Tel:</b> (678) 417-9848<br>
                            <a href="http://northviewhigh.com/index/ricciortho.com">ricciortho.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
