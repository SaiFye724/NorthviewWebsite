...
<html lang="en">
    <head>
        ...
        <title>Web Team | Northview High</title>
        ...
        <h4>IMPORTANT LINKS</h4>
            ...
            <a href="yearbook.php" target="_blank" style="color: black;"><li>Senior Ad Info</li></a><a href="linked_files/about/FreshmanCampFlyer.pdf" target="_blank" style="color: black;"><li>Freshman Camp Flyer</li></a><a href="linked_files/ParkingApp1718.doc" target="_blank" style="color: black;"><li>Parking Application 2017-18</li></a><a href="https://www.northviewcounseling.com/summer-assignments-2017" target="_blank" style="color: black;"><li>Summer Assignments 2017</li></a><a href="https://www.northviewcounseling.com/" target="_blank" style="color: black;"><li>Northview Counseling</li></a><a href="https://www.northviewcounseling.com/transcript-requests-" target="_blank" style="color: black;"><li>Request A Transcript</li></a><a href="https://www.peachjar.com/index.php?a=28&b=138&region=68281" target="_blank" style="color: black;"><li>Northview Peachjar</li></a><a href="http://session.cadystudios.com/" target="_blank" style="color: black;"><li>Cady Studios</li></a><a href="https://www3.fultonschools.org/hb91/home/index2" target="_blank" style="color: black;"><li>FCS HB91 Petition Form</li></a><a href="https://www.commonsense.org/education/digital-citizenship" target="_blank" style="color: black;"><li>Digital Citizenship Application</li></a><a href="https://www.youtube.com/watch?v=44znsLcLROw" target="_blank" style="color: black;"><li>NHS Morning Show (May 11)</li></a>        </ul>
                ...
                <div id="page-content">
                    ...
                    <hr>
                    <h4><b>2016 - 2017</b></h4>
                    <div class="team-profile julie-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/Julie_Pass.png">
                        </div>
                        <h4>Julie Xiang</h4>
                    </div>
                    <div class="team-profile sai-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/Sai_Pass.png">
                        </div>
                        <h4>Sai Maddali</h4>
                    </div>
                    <div class="team-profile vj-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/VJ_Pass.png">
                        </div>
                        <h4>Vijay Panthayi</h4>
                    </div>
                    <div class="team-profile thomas-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/Thomas_Pass.png">
                        </div>
                        <h4>Thomas Kent</h4>
                    </div>
                    <div class="team-profile yi-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/Yi_Pass.png">
                        </div>
                        <h4>Yi Liu</h4>
                    </div>
                    <div class="team-profile yusef-modal">
                        <div class="team-profile-picture">
                            <img src="img/team-pics/Yusef_Pass.png">
                        </div>
                        <h4>Yusuf Hafiane</h4>
                    </div>
                </div>
            ...
            <script type="text/javascript">
                /*$(document).ready(function() {
                    $(".julie-modal").click(function() {
                        alert("Hey, I'm Julie! Usually, I have my earbuds plugged in and eyes glued to the computer screen making graphics. If not, I'm probably eating.") 
                    });
                    
                    $(".sai-modal").click(function() {
                        alert("Hey! I'm a senior who loves doing design &amp; code work. I like rap &amp; country music. Follow me on twitter @saifye724.")
                    });
                    
                    $(".vj-modal").click(function() {
                         $("#nameTitle").text("Vijay Panthayi");
                         $("#bioInfo").text("");

                         $("#bioModal").modal("show"); 
                    });
                    
                    $(".thomas-modal").click(function() {
                         $("#nameTitle").text("Thomas Kent");
                         $("#bioInfo").text("My name is Thomas Kent, and this is my second year on the Northview Web Team. I am currently a senior at Northview, with plans of attending the University of Georgia! In my free time I enjoy playing soccer, producing music, and programming video games.");

                         $("#bioModal").modal("show"); 
                    });
                    
                    $(".yi-modal").click(function() {
                         $("#nameTitle").text("Yi Liu");
                         $("#bioInfo").text("");

                         $("#bioModal").modal("show"); 
                    });
                    
                    $(".yusef-modal").click(function() {
                         $("#nameTitle").text("Yusef Hafiane");
                         $("#bioInfo").text("Hello! My name is Yusuf Hafiane and I'm a member of the Northview Web Team. I handle both graphic design and development features.");
